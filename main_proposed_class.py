...
class Proposed_prune():
    def __init__(self, args) -> None:
        ...
        if args.prune_type == 'local':
            prune.random_unstructured(self.model.fc1, name='weight', amount=1.0-args.initial_percent*0.01)
            prune.random_unstructured(self.model.fc2, name='weight', amount=1.0-args.initial_percent*0.01)
            prune.random_unstructured(self.model.fc3, name='weight', amount=1.0-args.initial_percent*0.01)
