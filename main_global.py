...
parser.add_argument("--prune_type", default="lterative_original", type=str, help="lt | reinit")
parser.add_argument("--prune_conv1", default=True, type=bool)
...
def prune_model(model, percent, conv1=False):
    parameters_to_prune = []
    for name, module in model.named_modules():
