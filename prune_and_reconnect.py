...
class Prune_and_Reconnect(BasePruningMethod):
    ...
    def compute_mask(self, t, default_mask):
        ...
        if nparams_toprune != 0:  # k=0 not supported by torch.kthvalue
            ...
            topk = torch.topk(torch.abs(t).view(-1), k=2*nparams_toprune, largest=False)
            ...
            try: 
                ...
                None
            zero_indices = zero_indices.view(-1)[torch.randperm(zero_indices.nelement())].view(zero_indices.size())[0:nparams_toprune]
